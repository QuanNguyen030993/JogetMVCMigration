...
public class QuotationDetails : BaseModel
{
    ...
    public double? PremiumCfe { get; set; }
    public double? PremiumVoluntary { get; set; }
    public double? PremiumTotalBeforeVat { get; set; }
    public double? PremiumTotal { get; set; }
    public double? TmivShare { get; set; }
    public double? TopRiskPd { get; set; }
    public double? TopRiskPdQuotation { get; set; }
    public double? SumInsuredTotal { get; set; }
    public double? SumInsuredTotalUsd { get; set; }
