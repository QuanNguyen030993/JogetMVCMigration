...
{
    /// <inheritdoc />
    public partial class browser_excepption_control_1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "ClientBrowserError",
                columns: table => new
                {
                    ...
                    Time = table.Column<string>(type: "nvarchar(max)", maxLength: 8000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ClientBrowserError", x => x.Id);
                });
        }
