...
{
    /// <inheritdoc />
    public partial class password_config_v1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Attribute = table.Column<long>(type: "bigint", nullable: true),
                    PassWordHash = table.Column<string>(type: "nvarchar(max)", maxLength: 8000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileEncrypt", x => x.Id);
                });
        }
