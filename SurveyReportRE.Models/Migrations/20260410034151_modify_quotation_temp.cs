...
{
    /// <inheritdoc />
    public partial class modify_quotation_temp : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestTypeId = table.Column<long>(type: "bigint", nullable: true),
                    ...
                    LockedReferenceFields = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    ...
                    SurveyNeeded = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "0"),
                    ReinsuranceId = table.Column<long>(type: "bigint", nullable: true),
                    TurnAroundTimeAttributes = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
                    LocationId = table.Column<long>(type: "bigint", nullable: true),
                    ResId = table.Column<long>(type: "bigint", nullable: true),
                    PolicyNo = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuotationTmp", x => x.Id);
                });
        }
