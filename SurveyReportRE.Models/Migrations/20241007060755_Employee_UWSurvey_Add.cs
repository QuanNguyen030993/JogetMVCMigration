...
{
    /// <inheritdoc />
    public partial class Employee_UWSurvey_Add : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmployeeKnowAss = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Guid = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    FcmToken = table.Column<string>(type: "nvarchar(max)", maxLength: 8000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleDutyClaimMapping", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoleDutyClaimMapping_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RoleDutyMapping", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RoleDutyMapping_AspNetRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AspNetRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleDutyClaimMapping_RoleId",
                table: "RoleDutyClaimMapping",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RoleDutyMapping_RoleId",
                table: "RoleDutyMapping",
                column: "RoleId");
        }
